...
def ref_img_information(img_path):
...
if __name__ == '__main__':
    ...
    focal_length_bus = ref_img_information(bus_img_path)
    focal_length_car = ref_img_information(car_img_path)
    focal_length_motorcycle = ref_img_information(motorcycle_img_path)
    focal_length_person = ref_img_information(person_img_path)

    videoPath = 'data/video/testVideo.mp4'
